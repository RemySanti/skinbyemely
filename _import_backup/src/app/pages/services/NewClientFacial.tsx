...
import { Sparkles, Heart, Shield, CheckCircle2, ShoppingBag, Loader2 } from 'lucide-react';
import {
  Accordion,
  AccordionContent,
  AccordionItem,
...
import newClientFacialHeroImage from 'figma:asset/2489d2a804193c032a0061896ccc979f94df2152.png';
import newClientFacialImage from 'figma:asset/9216485faed7ea841dbf97e63a06906a4f46ca09.png';
...
export default function NewClientFacial() {
  ...
  const defaultService = getDefaultServicePrices().find(s => s.id === 'new-client-facial')!;
  ...
  useEffect(() => {
    ...
    fetchServicePrices().then(services => {
      const svc = getServiceById(services, 'new-client-facial');
      if (svc) {
  ...
  const combos = [
    {
      ...
      benefit: 'Enhanced exfoliation and product absorption',
      description: 'Popular Brandon facial combo for instant radiance',
      link: '/services/dermaplane-deluxe'
    },
    {
      service: 'Oxygen Infusion Add-On',
      benefit: 'Boosts hydration and cellular rejuvenation',
      description: 'Frequently paired for maximum glow',
      link: squareBookingUrl
    },
    {
      service: 'High Frequency Add-On',
      benefit: 'Kills acne-causing bacteria',
      description: 'Perfect for active breakouts',
      link: squareBookingUrl
    }
  ];
  ...
  const faqs = [
    {
      ...
      answer: "No downtime is required. You may experience slight redness immediately after extractions, but this typically subsides within 1-2 hours. This is one of the reasons why our Brandon facial clients love this treatment – you can easily schedule it during your lunch break or before an evening event."
    },
    {
      question: "Will my skin be sensitive after the treatment?",
      answer: "Most clients experience no sensitivity. The customized approach ensures we select products and techniques appropriate for your skin's current condition. We recommend avoiding harsh exfoliants and direct sun exposure for 24 hours post-treatment. Sunscreen is always essential, and we'll provide specific aftercare guidance."
    },
    {
      question: "How soon will I see results?",
      answer: "You'll notice immediate improvements in skin texture, clarity, and radiance. Your complexion will appear brighter and feel smoother right after your appointment. For deeper concerns like hyperpigmentation or fine lines, consistent monthly treatments yield the most dramatic, long-lasting results."
    },
    {
      question: "How often should I get this facial?",
      answer: "For optimal skin health, we recommend monthly facials. This aligns with your skin's natural renewal cycle (approximately 28 days). Monthly treatments help maintain clarity, prevent congestion, and address concerns before they become visible. Many of our Tampa Bay clients find this schedule easily fits into their self-care routine."
    },
    {
      question: "Is this facial suitable for first-time clients?",
      answer: "Absolutely! This treatment is specifically designed as an introduction to professional skincare at SkinByEmely. The comprehensive skin analysis and fully customized approach makes it perfect for first-timers. We'll assess your unique concerns and adjust every element of the treatment accordingly."
    },
    {
      question: "Can I wear makeup after my appointment?",
      answer: "We recommend allowing your skin to breathe for at least 4-6 hours post-treatment to maximize benefits. However, if necessary, mineral makeup can be applied. Most clients love their post-facial glow and prefer to go makeup-free!"
    }
  ];
    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-[80vh] min-h-[600px] flex items-center justify-center overflow-hidden texture-grain">
        <div 
          ...
          style={{ backgroundImage: `url("${newClientFacialHeroImage}")` }}
        >
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center px-4 pt-20">
          ...
          >
            <div className="inline-block px-4 py-1.5 bg-white/10 backdrop-blur-md border border-white/20 rounded-full mb-4">
              <span className="text-xs md:text-sm tracking-[0.2em] text-white/90 uppercase font-medium">First-Time Client Special</span>
            </div>
            
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif text-white leading-tight">
              New Client <br className="hidden md:block" />Customized Facial
            </h1>
            
            <p className="text-lg md:text-xl text-white/90 font-light max-w-2xl mx-auto leading-relaxed">
              Experience Your First Professional Facial in Brandon, Florida
            </p>
            
            <p className="text-base text-white/80 max-w-lg mx-auto">
              A go-to facial in Brandon, trusted by clients across Tampa Bay for results-driven, personalized skincare
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-6 text-xs md:text-sm text-white/70 pt-8 mt-8 border-t border-white/10 max-w-2xl mx-auto">
              <div className="flex items-center gap-2">
                ...
                <span className="uppercase tracking-wider">60 Minutes</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-[#d4af37]" />
                <span className="uppercase tracking-wider">$80</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-[#d4af37]" />
                <span className="uppercase tracking-wider">No Downtime</span>
              </div>
            </div>
          </motion.div>
        </div>
      ...
      {/* What This Facial Is Best For - Split Layout */}
      <section id="details" className="py-20 md:py-32 px-4 bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <span className="text-[#b8956a] uppercase tracking-widest text-sm font-medium mb-4 block">The Experience</span>
                ...
                <div>
                  ...
                  <ul className="space-y-4 ml-8">
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="font-medium text-[#2c2c2c]">First-time facial clients</p>
                        <p className="text-sm text-[#6b6b6b] font-light">Perfect introduction to professional skincare</p>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-[#b8956a] shrink-0 mt-0.5" />
                      <div>
                        <p className="font-medium text-[#2c2c2c]">Expert skin analysis seekers</p>
                        <p className="text-sm text-[#6b6b6b] font-light">Comprehensive evaluation of your unique concerns</p>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-[#b8956a] shrink-0 mt-0.5" />
                      <div>
                        <p className="font-medium text-[#2c2c2c]">Busy professionals</p>
                        <p className="text-sm text-[#6b6b6b] font-light">No downtime, maximum results</p>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-[#b8956a] shrink-0 mt-0.5" />
                      <div>
                        <p className="font-medium text-[#2c2c2c]">All skin types</p>
                        <p className="text-sm text-[#6b6b6b] font-light">Fully customized to your needs</p>
                      </div>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-[#faf8f5] p-8 border-l-2 border-[#b8956a]">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-1">
                      <p className="font-medium text-[#2c2c2c]">Congestion</p>
                      <p className="text-xs text-[#6b6b6b]">Deep cleansing & extractions</p>
                    </div>
                    <div className="space-y-1">
                      <p className="font-medium text-[#2c2c2c]">Dullness</p>
                      <p className="text-xs text-[#6b6b6b]">Enzyme exfoliation</p>
                    </div>
                    <div className="space-y-1">
                      <p className="font-medium text-[#2c2c2c]">Dehydration</p>
                      <p className="text-xs text-[#6b6b6b]">Custom hydrating masks</p>
                    </div>
                    <div className="space-y-1">
                      <p className="font-medium text-[#2c2c2c]">Texture</p>
                      <p className="text-xs text-[#6b6b6b]">Smoothing treatments</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      {/* Results & Benefits - Elegant Cards */}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <h3 className="text-xl font-serif text-white mb-4">Wellness Experience</h3>
              <ul className="space-y-3 text-white/70 font-light">
                <li className="flex items-center gap-2">
                  <span className="w-1.5 h-1.5 bg-[#d4af37] rounded-full" />
                  Deep relaxation
            ...
            >
              ...
              <h3 className="text-xl font-serif text-white mb-4">Personalized Care</h3>
              <ul className="space-y-3 text-white/70 font-light">
                <li className="flex items-center gap-2">
                  <span className="w-1.5 h-1.5 bg-[#d4af37] rounded-full" />
      ...
      <section id="combos" className="py-24 px-4 bg-[#faf8f5]">
        <div className="max-w-5xl mx-auto">
          <motion.div {...fadeIn} className="text-center mb-16">
            ...
            <p className="text-lg text-[#6b6b6b] font-light">Client-favorite combos to maximize your results</p>
          </motion.div>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <div className="relative z-10">
              <h3 className="text-3xl md:text-4xl font-serif text-white mb-6">Ready for Your Skin Transformation?</h3>
              <p className="text-lg mb-10 text-white/80 max-w-2xl mx-auto font-light">
                Join Tampa Bay clients who trust SkinByEmely for results-driven, luxurious skincare
              </p>
              <a href={squareBookingUrl} target="_blank" rel="noopener noreferrer">
              ...
              <p className="text-xs text-white/50 mt-6 tracking-wider uppercase">
                First-time client special: {servicePrice} for {serviceDuration.toLowerCase()}
              </p>
            </div>
          </motion.div>
        </div>
